...
class DIB {
	...
	public static $CODEUSE=0; // 0 = Always overwrite cache files (also occurs in 'development' mode); 
    ...
    public static $USERSPATH='/dropinbase/files/uploads'; // Physical path to user-file uploads folder (NOTE, keep outside webserver's reach for security reasons)
	...
	public static $BASEURL='https://dibangular.local';
	...
	public static $SYSTEMPATH='/dropinbase/vendor/dropinbase/dropinbase/';
    public static $EXTPATH= '/dropinbase/vendor/dropinbase/dropinbase/extensions/';

	public static $VENDORPATH= '/dropinbase/vendor/dropinbase/dropinbase/../../';
